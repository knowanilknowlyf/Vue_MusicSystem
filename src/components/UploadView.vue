  ...
  <div class="col-span-1">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      ...
      <div class="p-6">
        ...
        <hr class="my-6" />
        <!-- Progess Bars -->
        <div class="mb-4" v-for="(file, index) in uploadFiles" :key="index">
          <!-- File Name -->
          ...
          <div class="flex h-4 overflow-hidden bg-gray-200 rounded">
            <!-- Inner Progress Bar -->
            <div
              class="transition-all progress-bar text-center f-4 bg-blue-400"
              :class="file.variant"
      ...
      files.forEach((file) => {
        ...
        task.on(
          ...
          (snapshot) => {
            ...
            console.log(this.uploadFiles[uploadIndex].current_progress)
          },
          (error) => {
            console.log(error)
